...
from rlprompt.models import BaseModel, LMAdaptorModel, PromptModel, InputConditionedPromptModel
...
def make_prompt_model(model: BaseModel,
                             config: "DictConfig") -> PromptModel:
...
class LMAdaptorModelConfig:
    ...
    setting_theta: float = 0.4
    # The model initial paprameter
