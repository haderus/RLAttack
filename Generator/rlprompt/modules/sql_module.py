...
class SQLModule(BaseModule):
    def __init__(
        ...
        self._setting_theta=setting_theta
    ...
    def forward(self, batch: Dict[str, Any], clean_prompt: str, target_label: int) \
            -> Tuple[torch.Tensor, Dict[str, Any], Dict[Tuple, Tuple], Dict[Tuple, Tuple]]:
        loss_list = []
        loss_log_list = []
        for mode in self._forward_modes:
            _loss, _loss_log= self._forward(
    ...
    def infer(
        ...
        return self._model.generate(**batch,
                                    ...
                                    setting_theta=self.setting_theta,
                                    infer=True)
